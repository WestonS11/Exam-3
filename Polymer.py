...
class macroMolecule():
    def __init__(self, degreeOfPolymerization=1000, segmentLength=0.154E-9, merWt=14):
        ...
        #Degree of Poly needs changed to select degree of poly from normal distribution w/ N=mean and .1N=stdev
        sampled_N = rnd.normalvariate(degreeOfPolymerization, 0.1*degreeOfPolymerization) #mean=target N, stdev=.1N
        self.N= max(1, int(sampled_N)) #Makes sure it is at least 1 and is an integer
